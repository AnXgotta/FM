...
#define FM_SURFACE_Default		SurfaceType_Default
#define FM_SURFACE_Concrete		SurfaceType1
#define FM_SURFACE_Dirt			SurfaceType2
#define FM_SURFACE_Water		SurfaceType3
#define FM_SURFACE_Metal		SurfaceType4
#define FM_SURFACE_Wood			SurfaceType5
#define FM_SURFACE_Grass		SurfaceType6
#define FM_SURFACE_Glass		SurfaceType7
#define FM_SURFACE_Flesh		SurfaceType8
