...
#include "Online.h"
//#include "AFMLeaderboards.h"
#include "GameFramework/GameSession.h"
#include "FMGameSession.generated.h"

USTRUCT()
struct FFMGameSessionParams
{
...
UCLASS(config=Game)
class FM_API AFMGameSession : public AGameSession
{
...
protected: 
	...
	FFMGameSessionParams CurrentSessionParams;

	/** Current host settings */
	TSharedPtr<class FFMOnlineSessionSettings> HostSettings;
	/** Current search settings */
	TSharedPtr<class FFMOnlineSearchSettings> SearchSettings;
...
public:
	...
	static const int32 DEFAULT_NUM_PLAYERS = 24;
	...
	*/
	...
	virtual void EndPendingMatch() OVERRIDE;
